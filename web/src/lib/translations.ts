export const translations = {
  en: {
    ...
    assessmentTimeEstimate: 'Takes approximately 2-3 minutes',
    ...
    assessmentSystemTitle: 'Rule-Based Assessment System',
    testModeTitle: 'Developer Test Mode',
    testScenario1: 'Test Scenario 1: Moderate Sleep Issues',
    testScenario2: 'Test Scenario 2: Severe Sleep Issues',
    testScenario3: 'Test Scenario 3: Good Sleep Habits',
    testModeDescription: 'These test scenarios automatically fill in answers for quick assessment testing',
  ...
  zh: {
    ...
    assessmentTimeEstimate: '大约需要2-3分钟',
    assessmentPrivacyNote: '您的回答将被保密，仅用于提供个性化建议。',
    assessmentHelpLink: '需要帮助？了解更多关于评估的信息',
    assessmentSystemTitle: '规则评估系统',
    testModeTitle: '开发者测试模式',
    testScenario1: '测试场景1: 中度睡眠问题',
    testScenario2: '测试场景2: 严重睡眠问题',
    testScenario3: '测试场景3: 良好睡眠习惯',
    testModeDescription: '这些测试场景会自动填充答案，用于快速测试评估功能',
    loadingQuestions: '加载问题中...',
    questionProgress: '问题 {current} / {total}',
    processingAssessment: '正在生成评估结果...',
    viewResults: '查看结果',
    nextQuestion: '下一题',
